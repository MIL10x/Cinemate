    ...
    <>
      <section className="grid gap-20 grid-cols-2 max-lg:grid-cols-1 dark:text-white mt-20">
        ...
        <div>
          ...
          {popup && (
            <div className="absolute bg-black/25 h-screen max-lg:h-[150vh] w-screen z-50 flex justify-center items-center  backdrop-blur-sm top-0 left-0 ">
              <div className="relative bg-black flex max-lg:h-[150vh] max-lg:w-screen justify-center items-center max-lg:flex-col max-lg:justify-normal dark:bg-gray-800 max-lg:rounded-none rounded-xl w-[70%] p-3 h-[60%]">
                <button
